...
struct elf_file {
    // Full path to the elf file in the FS
    ...
    // The virtual base address of this binary (smallest vaddr of all the
    // segments)
    void *virtual_base_address;

    // The ending virtual address (largest vaddr of all the segments)
